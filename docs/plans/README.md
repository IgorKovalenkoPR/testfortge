...
| [adr/0002-artifact-storage.md](adr/0002-artifact-storage.md) | ADR · **Proposed** | Artefact storage for R3: local disk + one S3-compatible adapter, keyed per org/project, configured per organisation over an instance default — **awaiting the owner's approval before E8.2 starts** | — |
