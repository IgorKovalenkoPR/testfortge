...
def _forms_test_cases() -> list[TCTemplate]:
    return [
        TCTemplate(
            ...
            # Quoted values are critical: the automation parser extracts
            # them and types them via Playwright. Without quotes the
            # runner does loc.fill('') and the .webm shows no typing.
            steps=["Scroll down to the form section",
                   "Fill the 'name' field with 'Olena Marchenko'",
                   "Fill the 'email' field with 'tester@example.com'",
                   "Fill the 'message' field with 'Smoke test from TestForTge'",
                   "Click the 'Submit' button",
                   "Verify 'Thank you' is displayed",
                   "Scroll up to the top"],
            test_data="Name: Olena Marchenko, Email: tester@example.com, Message: Smoke test from TestForTge",
        ...
        TCTemplate(
            ...
            preconditions="Application is accessible. Form page is opened.",
            steps=["Scroll down to the form",
                   "Fill the 'email' field with ''",
                   "Click the 'Submit' button",
                   "Verify 'required' is displayed"],
