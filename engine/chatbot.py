...
_HELP_UA = {
    ...
    "checklist": (
        # Двома різними написаннями в одному реченні ("Чек-ліст" і
        # "чеклист") — приведено до одного, і додано те саме, що й в
        # англійській версії: структуру, а не лише формат ідентифікаторів.
        "**Чек-ліст** формує чек-ліст низького рівня (HDR_001, FTR_001…) — "
        "по одній спостережній перевірці на пункт, згрупованих у секції за "
        "областями сторінки, з номерами як стабільними ідентифікаторами. Він "
        "обмінює детальність кроків на ширину покриття, тож використовуйте "
        "для швидкого регресу або смоук-проходу. Ті самі джерела, що й у "
        "Test Cases."
    ),
    "test_execution": (
