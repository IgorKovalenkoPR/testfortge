...
TRANSLATIONS = {
    ...
    # ── The guide's shell (§14) ────────────────────────────────────
    # The panels themselves are HTML partials per language
    # (templates/guide/_sections_<lang>.html) — a 4 800-word document does
    # not belong in a dictionary a sentence at a time. These are the card
    # labels, which are interface, not prose.
    "guide_page_title": "Guide",
    "guide_page_h1": "User Guide",
    "guide_page_intro": "Pick a module to see how it works end-to-end. Each "
    ...
    "guide_card_estimation_sub": "Min/Max hours from text · mockups · URL",
    "guide_card_test_cases_title": "Test Cases",
    "guide_card_test_cases_sub": "ISTQB-shaped TC pack from requirements",
    "guide_card_checklist_title": "Checklist",
    "guide_card_checklist_sub": "Low-level atomic coverage list",
    ...
    "guide_card_automation_sub": "TypeScript + Playwright suite out · Allure "
                                 "results in",
    "guide_card_bug_reports_title": "Bug Reports",
    "guide_card_bug_reports_sub": "ISTQB-aligned defect store, Jira-friendly",
    "guide_card_tedgie_title": "Tedgie chat",
